(() => {
        ...
        imageElements.forEach((imageElement => {
            ...
            function playFrames() {
                ...
                interval = setInterval((() => {
                    ...
                    if (currentFrame === totalFrames) direction = -1; else if (currentFrame === 1) direction = 1;
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        ...
        if (imageElementForScroll) {
            function changeImageBasedOnScroll() {
                ...
                const scrollPercentage = Math.min(Math.max(0, -rect.top / contentHeight), 1);
                currentImageIndex = Math.floor(scrollPercentage * (totalImages - 1)) + 1;
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        ...
        if (form && sentForm && nameInput) form.addEventListener("submit", (function(e) {
            e.preventDefault();
            if (!nameInput.value.trim()) nameInput.classList.add("_error"); else {
